...
describe "Testa o modelo Metric" do
	context "Testa argumentos" do
		it "tem que lançar exceção se não houver parametros" do
			assert_raises ArgumentError do
				Metric.new
			end
		end
		it "tem que lançar exceção se não o parametro lng" do
			assert_raises ArgumentError do
				Metric.new(100, nil)
			end
		end
		it "tem que lançar exceção se não o parametro lat" do
			assert_raises ArgumentError do
				Metric.new(nil, 100)
			end
		end
